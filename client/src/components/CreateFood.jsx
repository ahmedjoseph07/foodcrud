    ...
    <div>
      ...
      <div className="side-main flex">
        <div className="sidebar w-56 h-[calc(100vh-4rem)] bg-gray-200 ">
          <div className="menuwrapper flex justify-center items-center">
            <div className="menulist w-[200px] h-[95px] mt-6">
              ...
              <div className="create flex gap-1 w-48 h-10 text-indigo-500 bg-indigo-900 bg-opacity-20  items-center rounded-md font-semibold cursor-pointer">
        ...
        <div className="main flex-1 bg-white">
          ...
          <button className="mx-4 my-12 rounded-xl bg-[#5A67BA] text-white px-8 py-2 font-bold">Create</button>
          </form>
        </div>
      </div>
    </div>
